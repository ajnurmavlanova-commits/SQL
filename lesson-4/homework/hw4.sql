...
7.SELECT EmployeeID,FirstName,LastName,DepartmentName,Salary,HireDate,Age,ISNULL(Email, 'noemail@example.com') AS Email,Country FROM Employees
...
12.SELECT EmployeeID,COALESCE(FirstName, LastName) AS Name,DepartmentName,Salary,HireDate,Age,Email,Country FROM Employees
...
21.SELECT EmployeeID,FirstName,LastName,(FirstName + ' ' + LastName) AS FullName,DepartmentName,Salary,HireDate,Age,Email,Country FROM Employees
